...
const Post = ({ post, exchangeRate, profile, nodes, isRepost }) => {
    ...
    return (
        <div className={`${isRepost ? `my-2  rounded-xl ` : ``} flex flex-1 bg-white border ${!isRepost ? `hover:bg-gray-50/80` : `hover:bg-gray-100/50`} transition duration-100 border-gray-200 p-[15px] flex-col w-full max-w-md`}>
